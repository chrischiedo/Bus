...
public class PassengerDetailsUpdate extends JInternalFrame {
    ...
    public PassengerDetailsUpdate(String s1, String s2, String s3, String s4, String s5, String s6, String s7) {
