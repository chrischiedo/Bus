...
public class NewEmployeeEntry extends JInternalFrame {

    Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();
    private final JLabel empNo;
    ...
    public NewEmployeeEntry(String emp, String sname, String fname, String lname, String gender,
    ...
    private void openFile() {
        int returnVal = fc.showOpenDialog(NewEmployeeEntry.this);
